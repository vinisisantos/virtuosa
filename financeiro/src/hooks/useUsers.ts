...
export const DEFAULT_PERMISSIONS: UserPermissions = {
  ...
  crm: false, crmPipelineStages: false, crmEvaluationsAll: false,
...
export const PERMISSION_LABELS: Record<string, string> = {
  ...
  crm: 'Acesso Exclusivo ao CRM', crmPipelineStages: 'Gerenciar Colunas do Pipeline',
  crmEvaluationsAll: 'Gerenciar todas as avaliações da unidade',
...
export const PERMISSION_ICONS: Record<string, string> = {
  ...
  crm: 'support_agent', crmPipelineStages: 'view_column', crmEvaluationsAll: 'event_available',
...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  { label: 'CRM', icon: 'support_agent', color: '#14b8a6', description: 'Acesso exclusivo de atendimento ao cliente',
    keys: ['crm', 'crmPipelineStages', 'crmEvaluationsAll'] },
...
export function useUsers() {
  ...
  const formatRole = (r: string) => {
    const roleMap: Record<string, string> = {
      ADMINISTRADOR: 'Administrador', GERENTE: 'Gerente', SECRETARIA: 'Secretária', MARKETING: 'Marketing',
