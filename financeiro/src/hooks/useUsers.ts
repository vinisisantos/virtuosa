...
export const DEFAULT_PERMISSIONS: UserPermissions = {
  ...
  crm: false, crmSilentAnalysis: false, crmPipelineStages: false, crmEvaluationsAll: false,
...
export const PERMISSION_ICONS: Record<string, string> = {
  ...
  crm: 'support_agent', crmSilentAnalysis: 'psychology', crmPipelineStages: 'view_column', crmEvaluationsAll: 'event_available',
...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  { label: 'CRM', icon: 'support_agent', color: '#14b8a6', description: 'Acesso exclusivo de atendimento ao cliente',
    keys: ['crm', 'crmSilentAnalysis', 'crmPipelineStages', 'crmEvaluationsAll'] },
