        ...
        <div className={styles.container}>
          <section className={styles.hero} aria-labelledby={titleId}>
            <div className={styles.intro}>
              <span className={styles.kicker}>Estética avançada em {config.city}</span>
              <h1 className={styles.display} id={titleId}>
              ...
              <p className={styles.sub}>
                Na Clínica Virtuosa {config.city}, cada tratamento começa por uma avaliação individual, feita com calma e sem compromisso. Deixe seu nome e telefone — nossa equipe entra em contato pelo WhatsApp para encontrar o melhor horário.
              </p>
            </div>

            <div className={styles.formColumn} id="formulario">
              <div className={styles.leadForm}>
                <h2 className={styles.formTitle}>Agende sua avaliação gratuita em {config.city}</h2>
                <p className={styles.formNote}><ClockIcon />Leva menos de 30 segundos</p>

                <form className={styles.form} aria-label={`Formulário de avaliação — Clínica Virtuosa ${config.city}`}>
                  ...
                  {config.whatsappUrl ? (
                    ...
                    <button
                      ...
                      type="button"
                      aria-disabled="true"
                      title="Rascunho visual — o WhatsApp desta unidade ainda não foi configurado"
                    >
                      <WhatsAppIcon />
                      <span>Quero minha avaliação gratuita</span>
                    </button>
                  ...
                  <p className={styles.lgpd}>
                    Avaliação gratuita e sem compromisso. Ao enviar, você concorda em ser contatada pela Clínica Virtuosa {config.city}. Seus dados são usados apenas para o agendamento, conforme a LGPD.
                  </p>
                </form>
              </div>
            </div>
