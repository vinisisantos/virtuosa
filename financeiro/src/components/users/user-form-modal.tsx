        ...
        <form onSubmit={p.handleSave} style={{ padding: '24px 32px 32px' }}>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div><label style={labelS}>Cargo</label><select value={p.formRole} onChange={e => p.setFormRole(e.target.value)} style={inputS}><option value="ADMINISTRADOR">Administrador</option><option value="GERENTE">Gerente</option><option value="SECRETARIA">Secretária</option><option value="MARKETING">Marketing</option><option value="VENDEDOR">Vendedor</option><option value="ESTETICISTA">Esteticista</option></select></div>
            </div>
