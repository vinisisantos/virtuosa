                                ...
                                return (
                                    <tr key={order.id} style={{ borderBottom: '1px solid var(--border)', transition: 'var(--transition)' }} className="hover-row">
                                        ...
                                        <td style={{ ...tdS, whiteSpace: 'nowrap' }}>
                                            ...
                                            {eta && (
                                                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 3, marginTop: 3, padding: '1px 6px', borderRadius: 6, fontSize: '0.7rem', fontWeight: 700, background: `${eta.color}15`, color: eta.color, border: `1px solid ${eta.color}25` }}>
