...
export const AI_TRAINING_CADERNO_ENTRIES: AiTrainingCadernoEntry[] = [
  ...
  },
  {
    ...
    aliases: [
      ...
      "ácido hialurônico nos glúteos",
      "hyper glúteo",
      "modeladora de glúteo",
    ],
    category: "injetaveis",
    autonomy: "humano",
    answer: "A harmonização de glúteos é um planejamento personalizado para trabalhar volume e contorno da região. Quando o protocolo usa ácido hialurônico, o produto acrescenta volume no local aplicado; procedimentos corporais complementares podem ter objetivos diferentes. A quantidade, os pontos e a combinação precisam ser definidos presencialmente pela profissional após avaliar a anatomia e o objetivo da cliente.",
    limits: "Não indicar candidatura, produto, volume, pontos de aplicação ou combinação pelo chat. A quantidade anunciada pertence somente à condição publicitária da campanha e não substitui a avaliação.",
    redFlags: "Dor intensa ou crescente, pele pálida, cinza, azulada ou fria, padrão arroxeado, falta de ar ou inchaço súbito após aplicação exigem atendimento imediato.",
  },
  {
